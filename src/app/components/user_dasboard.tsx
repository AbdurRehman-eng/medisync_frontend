      ...
      <div className="bg-white p-10 rounded-xl shadow-2xl max-w-lg w-full">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full px-6 py-3 bg-blue-600 text-white text-lg font-semibold rounded-lg hover:bg-green-700 transition"
          >
            Check Appointments
          </button>
          <button
            onClick={() => router.push("/pages/search")}
            className="w-full px-6 py-3 bg-blue-600 text-white text-lg font-semibold rounded-lg hover:bg-purple-700 transition"
          >
            Go to Search
          </button>
          <button
            onClick={handleSignOut}
            className="w-full px-6 py-3 bg-blue-600 text-white text-lg font-semibold rounded-lg hover:bg-red-700 transition"
          >
            Sign Out
          </button>
        </div>
