    ...
    >
      ...
      <div className="h-20 w-full bg-gradient-to-t from-[#001f3d] to-[#00457c] fixed top-0 left-0 flex justify-between items-center px-6 z-[1000]">
        ...
        <button
          ...
          className="bg-[#D1D1D1] hover:bg-[#A0A0A0] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1a6ed7] transform transition-all duration-300 hover:scale-[1.02] py-2 px-4 rounded-lg font-semibold"
        >
          Sign Out
        </button>
      </div>
