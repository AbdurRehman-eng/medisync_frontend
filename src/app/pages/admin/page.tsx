...
export default function Inpu() {
  ...
  const [showForm, setShowForm] = useState<boolean>(false); // Toggle for form visibility
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4">
      <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-xl">
        <h1 className="text-2xl font-semibold text-green-600 mb-6 text-center">Medicine Management</h1>
        ...
        <div className="flex justify-center space-x-4 mb-6">
          ...
          <button
            onClick={() => router.push('/pages/show_data')}
            className="bg-green-600 text-white py-2 px-4 rounded-md shadow hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500"
          >
            Show Data
          </button>
        </div>
