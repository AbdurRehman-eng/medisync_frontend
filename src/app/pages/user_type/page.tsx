...
const UserType: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#001f3d] to-[#00457c] p-4">
            <div className="flex space-x-[6vw]">
                <div className="w-[24vw] h-[24vw] bg-gray-200 rounded-[20px] flex flex-col items-center justify-center gap-4 p-4 transform transition-all hover:scale-[1.02]">
                    ...
                    <button
                        className="w-full px-4 py-2 bg-[#001f3d] text-white rounded-md hover:bg-[#003366] transform transition-all hover:scale-[1.02"
